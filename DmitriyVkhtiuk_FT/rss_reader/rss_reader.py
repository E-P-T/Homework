...
parser.add_argument("--version", help="Print version info", action='version', version=f'Version {1.4}')
parser.add_argument("--date",
                    help="Fetch news from local cache", default=None, type=str, )
...
def main():
    ...
    news = NewsBrain(args.source, args.limit, args.json, args.date, args.html_path, args.pdf_path)
    lim = args.limit
    if args.verbose:
        news.create_logger()
