...
def goldbach(num):
    ...
    result = 0
    if num % 2 == 0:
        prime = [x for x in range(1, num) if all(x % y != 0 for y in range(2, x))]
        while result != num:
        ...
        raise NotIntegerNumber("Not Even Number Occurred!")
    return x, y
    ...
    while True:
        ...
        if number == "q":
            ...
            try:
                ...
                print(f"Occurred: {exc}! You are doing something wrong!")
