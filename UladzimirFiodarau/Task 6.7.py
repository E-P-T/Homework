...
class Money(object):
    ...
    def convert(self, other):
        return round(self.get_value() * self.exchange_rate[other.get_curr()] / self.exchange_rate[self.get_curr()], 4)

    def __add__(self, other):
        if isinstance(other, Money):
            return Money(round(self.get_value() + other.convert(self), 4), self.get_curr())
        elif isinstance(other, int) or isinstance(other, float):
            return Money(round(self.get_value() + other, 4), self.get_curr())
    ...
    def __eq__(self, other):
        if isinstance(other, Money):
            return round(self.get_value(), 4) == round(other.convert(self), 4)
        elif isinstance(other, int) or isinstance(other, float):
            return round(self.get_value(), 4) == round(other, 4)
